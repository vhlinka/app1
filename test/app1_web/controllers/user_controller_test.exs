defmodule App1Web.UserControllerTest do
  ...
  @create_attrs %{company_access: "some company_access", first_name: "some first_name", last_name: "some last_name", password_hash: "some password_hash", role: "some role", username: "some username"}
  ...
  def fixture(:user) do
    {:ok, user} = Security.create_user(@create_attrs)
    user
  end
  ...
  describe "update user" do
    ...
    test "redirects when data is valid", %{conn: conn, user: user} do
      ...
      assert html_response(conn, 200) =~ "some updated company_access"
    end
